...
```text
请安装并使用这个固定版本的 Skill：
https://github.com/xuanqing-95/xuanqing-visual-explainer-cards/releases/tag/v1.1.2
...
```bash
git clone --branch v1.1.2 --depth 1 https://github.com/xuanqing-95/xuanqing-visual-explainer-cards.git \
...
openclaw skills install \
  git:xuanqing-95/xuanqing-visual-explainer-cards@v1.1.2 \
  --global
```
