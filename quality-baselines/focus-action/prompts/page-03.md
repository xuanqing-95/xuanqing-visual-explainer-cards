...
PURPOSE
The reader should understand: one complex task is broken down into three smaller, manageable steps, each completed and recorded.
...
The main diagram, including all blocks and marks, must occupy 68-80% of the canvas width and 68-80% of the canvas height.
...
The full image canvas is 1024x1024.
Place all important objects inside x=112-912 and y=112-912.
